...
export function MorphingCardStack({
  ...
  return (
    <div className={cn("space-y-4", className)}>
      {/* Layout Toggle */}
      <div className="flex items-center justify-center gap-1 rounded-lg bg-slate-800/60 p-1 w-fit mx-auto">
            ...
            {displayCards.map((card) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    "cursor-pointer rounded-xl border border-slate-700 bg-slate-800 p-4",
                ...
                >
                  <div className="flex items-start gap-3">
                    {card.icon && (
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-slate-700 text-blue-400">
                        {card.icon}
                      </div>
                    )}
