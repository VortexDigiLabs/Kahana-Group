  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white max-w-4xl font-bold uppercase tracking-tighter">
          Proven <span className="text-blue-500">Track Record</span>
        </h2>
        <p className="text-slate-300 text-sm md:text-base max-w-sm">
          Delivering high-impact projects across retail, corporate, and industrial sectors with industry-leading precision.
        </p>
      </div>
